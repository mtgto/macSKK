...
final class NumberEntryTests: XCTestCase {
    ...
    func testNumberCandidateToString() throws {
        ...
        XCTAssertEqual(try NumberCandidate(yomi: "#9").toString(yomi: NumberYomi(yomi: "3")!), nil, "数値は2桁で11 - 99である必要がある")
        ...
        XCTAssertEqual(try NumberCandidate(yomi: "#0").toString(yomi: NumberYomi(yomi: "1,2")!), nil, "数値の数が合わないとnil")
