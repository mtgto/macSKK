...
final class StateMachineTests: XCTestCase {
    ...
    func testHandleNormalRomaji() throws {
        ...
        stateMachine.inputMethodEvent.collect(16).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("n")])))
            XCTAssertEqual(events[1], .fixedText("ん"))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("g")])))
            XCTAssertEqual(events[3], .fixedText("が"))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("f")])))
            XCTAssertEqual(events[5], .fixedText("ふ"))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("d")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("dh")])))
            XCTAssertEqual(events[8], .fixedText("でぃ"))
            XCTAssertEqual(events[9], .markedText(MarkedText(text: [.plain("t")])))
            XCTAssertEqual(events[10], .markedText(MarkedText(text: [.plain("th")])))
            XCTAssertEqual(events[11], .fixedText("てぃ"))
            XCTAssertEqual(events[12], .markedText(MarkedText(text: [.plain("b")])))
            XCTAssertEqual(events[13], .markedText(MarkedText(text: [.plain("by")])))
            XCTAssertEqual(events[14], .markedText(MarkedText(text: [.plain("n")])))
    ...
    func testHandleNormalSpace() throws {
        ...
        stateMachine.inputMethodEvent.collect(2).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("s")])))
    ...
    func testHandleNormalSpecialSymbol() throws {
        ...
        stateMachine.inputMethodEvent.collect(18).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[1], .fixedText("〜"))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[3], .fixedText("‥"))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[5], .fixedText("…"))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[7], .fixedText("・"))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[9], .fixedText("←"))
            XCTAssertEqual(events[10], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[11], .fixedText("↓"))
            XCTAssertEqual(events[12], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[13], .fixedText("↑"))
            XCTAssertEqual(events[14], .markedText(MarkedText(text: [.plain("z")])))
            XCTAssertEqual(events[15], .fixedText("→"))
            XCTAssertEqual(events[16], .markedText(MarkedText(text: [.plain("z")])))
    ...
    func testHandleNormalRegistering() throws {
        ...
        stateMachine.inputMethodEvent.collect(5).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽あ")])))
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：あ]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("い")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("い"), .plain("▽う")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleNormalStickyShift() {
        ...
        stateMachine.inputMethodEvent.collect(6).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[1], .fixedText("；"))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽い")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽い*")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽い*j")])))
            expectation.fulfill()
        }.store(in: &cancellables)
    ...
    func testHandleNormalCancel() {
        let expectation = XCTestExpectation()
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽え")])))
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：え]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽え")])))
            expectation.fulfill()
        }.store(in: &cancellables)
    ...
    func testHandleNormalAbbrev() {
        ...
        stateMachine.inputMethodEvent.collect(12).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽a")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽al")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽alL")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽alLq")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("▽alLqQ")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("▽alLqQ_")])))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("▽alLqQ_<")])))
            XCTAssertEqual(events[9], .markedText(MarkedText(text: [.plain("▽alLqQ_<>")])))
            XCTAssertEqual(events[10], .markedText(MarkedText(text: [.plain("▽alLqQ_<>?")])))
            XCTAssertEqual(events[11], .markedText(MarkedText(text: [.plain("▽alLqQ_<>?A")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "/")))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a")))
    ...
    func testHandleComposingNandQ() {
        let expectation = XCTestExpectation()
        stateMachine.inputMethodEvent.collect(6).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽お")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽おn")])))
            XCTAssertEqual(events[2], .fixedText("オン"))
            XCTAssertEqual(events[3], .modeChanged(.katakana, .zero))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽n")])))
    ...
    func testHandleComposingVandQ() {
        let expectation = XCTestExpectation()
        stateMachine.inputMethodEvent.collect(6).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽v")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽う゛")])))
            XCTAssertEqual(events[2], .fixedText("ヴ"))
            XCTAssertEqual(events[3], .modeChanged(.katakana, .zero))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽v")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽ヴ")])))
            expectation.fulfill()
        }.store(in: &cancellables)
    ...
    func testHandleComposingContainNumber() throws {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽あ")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽あ1")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽あ1s")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽あ1す")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
    ...
    func testHandleComposingEnter() {
        ...
        stateMachine.inputMethodEvent.collect(13).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("k")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("n")])))
            XCTAssertEqual(events[3], .fixedText("ん"))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽s")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("▽す")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("▽す*")])))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("▽す*s")])))
            XCTAssertEqual(events[9], .fixedText("す"))
            XCTAssertEqual(events[10], .markedText(MarkedText(text: [.plain("t")])))
            XCTAssertEqual(
                events[11], .markedText(MarkedText(text: [.plain("▽た")])), "ローマ字1文字目はシフトなし、2文字目シフトありだと入力開始")
    ...
    func testHandleComposingBackspace() {
        ...
        stateMachine.inputMethodEvent.collect(10).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽s")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽sh")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽しゅ")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽し")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽し*t")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("▽し*")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("▽し")])))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[9], .markedText(MarkedText(text: [])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleComposingSpaceOkurinashi() {
        ...
        stateMachine.inputMethodEvent.collect(7).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽t")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼戸")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼都")])))
            XCTAssertEqual(events[5], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("[登録：と]")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t")))
    ...
    func testHandleComposingOkuriari() {
        ...
        stateMachine.inputMethodEvent.collect(8).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽t")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽と*r")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼取る")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.emphasized("▼撮る")])))
            XCTAssertEqual(events[6], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("[登録：と*る]")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t")))
    ...
    func testHandleComposingOkuriari2() {
        ...
        stateMachine.inputMethodEvent.collect(10).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽t")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽とr")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽とら")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽とらw")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.emphasized("▼捕わ")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.emphasized("▼捉わ")])))
            XCTAssertEqual(events[8], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[9], .markedText(MarkedText(text: [.plain("[登録：とら*わ]")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t")))
    ...
    func testHandleComposingOkuriari3() {
        ...
        stateMachine.inputMethodEvent.collect(9).sink { events in
            ...
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽とr")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽と*ry")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.emphasized("▼取りゃ")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.emphasized("▼撮りゃ")])))
            XCTAssertEqual(events[7], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("[登録：と*りゃ]")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t")))
    ...
    func testHandleComposingOkuriariIncludeN() {
        ...
        stateMachine.inputMethodEvent.collect(7).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽k")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽か")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽かn")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽かん*z")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼感じ")])))
            XCTAssertEqual(events[5], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("[登録：かん*じ]")])))
            expectation.fulfill()
        }.store(in: &cancellables)
    ...
    func testHandleComposingOkuriSokuon() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽あ")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽あ*t")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽あ*っt")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼会った")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t", withShift: true)))
    ...
    func testHandleComposingOkuriSokuon2() {
        ...
        stateMachine.inputMethodEvent.collect(5).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽あ*t")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽あ*っt")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽あ*っっt")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼会っった")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t", withShift: true)))
    ...
    func testHandleComposingOkuriSokuon3() {
        ...
        let expectation = XCTestExpectation()
        stateMachine.inputMethodEvent.collect(5).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽y")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽や")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽やt")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽やっt")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼八つ")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "y", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a")))
    ...
    func testHandleComposingOkuriN() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽あ")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽あ*n")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽あ*んd")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼編んだ")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "n", withShift: true)))
    ...
    func testHandleComposingOkuriCursor() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽あ")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽あい")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽あ"), .cursor, .plain("い")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼会う")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i")))
    ...
    func testHandleComposingCursorSpace() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽え")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽えい")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽え"), .cursor, .plain("い")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼絵")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "e", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i")))
    ...
    func testHandleComposingCtrlJ() {
        ...
        stateMachine.inputMethodEvent.collect(9).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽お")])))
            XCTAssertEqual(events[2], .fixedText("お"))
            XCTAssertEqual(events[3], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[4], .modeChanged(.katakana, .zero))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("▽オ")])))
    ...
    func testHandleComposingPrintableOkuri() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽え")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽えr")])))
            XCTAssertEqual(events[2], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：え*る]")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "e", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "r")))
    ...
    func testHandleComposingPrintableAndL() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽え")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽えb")])))
    ...
    func testHandleComposingPrintableSymbol() {
        ...
        stateMachine.inputMethodEvent.collect(5).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽s")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽ー")])), "Romaji.symbolTableに対応")
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽ーt")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽ーty")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽ー、")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "s", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "-")))
    ...
    func testHandleComposingCancel() {
        ...
        stateMachine.inputMethodEvent.collect(6).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽い")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽い*")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽い*s")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽い")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i")))
    ...
    func testHandleComposingCtrlQ() {
        ...
        stateMachine.inputMethodEvent.collect(5).sink { events in
            ...
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽い")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽い*k")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i")))
    ...
    func testHandleComposingLeftRight() {
        ...
        stateMachine.inputMethodEvent.collect(9).sink { events in
            ...
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽い")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽"), .cursor, .plain("い")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽あ"), .cursor, .plain("い")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("▽あえ"), .cursor, .plain("い")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("▽あえい")])))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("▽あえい*k")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .left, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleComposingCursor() {
        ...
        stateMachine.inputMethodEvent.collect(5).sink { events in
            ...
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽あ"), .cursor, .plain("い")])))
            XCTAssertEqual(events[3], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("[登録：あ]")])), "カーソル前までの文字列を登録時の読みとして使用する")
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i")))
    ...
    func testHandleComposingCtrlACtrlE() {
        ...
        stateMachine.inputMethodEvent.collect(9).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽あ")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽あい")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽"), .cursor, .plain("あい")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("▽う"), .cursor, .plain("あい")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("▽うあい")])))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("▽うあいえ")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleComposingLeftAndBackspace() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽あい")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽あ"), .cursor, .plain("い")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽"), .cursor, .plain("い")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i")))
    ...
    func testHandleComposingAbbrevSpace() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .modeChanged(.direct, .zero))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽b")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼美")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "/")))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "b")))
    ...
    func testHandleRegisteringEnter() {
        ...
        stateMachine.inputMethodEvent.collect(9).sink { events in
            ...
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：あ]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("s")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("そ")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("そ"), .plain("▽お")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("そ"), .emphasized("▼尾")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("そ尾")])))
    ...
    func testHandleRegisteringEnterEmpty() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            ...
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：あ]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽あ")])), "空文字列を登録しようとしたらキャンセル扱いとする")
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleRegisteringStickyShift() {
        ...
        stateMachine.inputMethodEvent.collect(7).sink { events in
            ...
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：あ]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain("▽")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("[登録：あ]")])))
            XCTAssertEqual(events[5], .modeChanged(.direct, .zero))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("[登録：あ]"), .plain(";")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "a", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleRegisteringLeftRight() {
        ...
        stateMachine.inputMethodEvent.collect(15).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽い")])))
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：い*う]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：い*う]")])))  // .left
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("[登録：い*う]")])))  // .right
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("[登録：い*う]"), .plain("え")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("[登録：い*う]"), .cursor, .plain("え")])))  // .left
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("[登録：い*う]"), .cursor, .plain("え")])))  // .left
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.plain("[登録：い*う]"), .plain("あ"), .cursor, .plain("え")])))  // "あ"と"え"の間にカーソル
            XCTAssertEqual(events[9], .markedText(MarkedText(text: [.plain("[登録：い*う]"), .plain("あえ")])))  // .right
            XCTAssertEqual(events[10], .markedText(MarkedText(text: [.plain("[登録：い*う]"), .plain("あ"), .cursor, .plain("え")])))  // .left
    ...
    func testHandleRegisteringBackspace() {
        ...
        stateMachine.inputMethodEvent.collect(7).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽い")])))
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：い]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：い]"), .plain("う")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("[登録：い]"), .plain("うえ")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("[登録：い]"), .plain("う"), .cursor, .plain("え")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("[登録：い]"), .cursor, .plain("え")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleRegisteringCancel() {
        ...
        stateMachine.inputMethodEvent.collect(7).sink { events in
            ...
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：い]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：い]"), .plain("う")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("[登録：い]"), .plain("う"), .plain("▽え")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("[登録：い]"), .plain("う")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("▽い")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleRegisterN() {
        ...
        stateMachine.inputMethodEvent.collect(8).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽m")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽も")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("▽もn")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼門")])))
            XCTAssertEqual(events[5], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.plain("[登録：もん]")])))
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.plain("▽もん")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .stickyShift, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleRegisteringCtrlY() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            ...
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：い]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("[登録：い]"), .plain("クリップボード")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "i", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testHandleSelectingEnter() {
        ...
        let expectation = XCTestExpectation()
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽t")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.emphasized("▼戸")])))
    ...
    func testHandleSelectingEnterOkuriari() {
        ...
        stateMachine.inputMethodEvent.collect(5).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽t")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("▽と*r")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼取ろ")])))
    ...
    func testHandleSelectingBackspace() {
        ...
        stateMachine.inputMethodEvent.collect(6).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.emphasized("▼戸")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼都")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼戸")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("▽と")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "o")))
    ...
    func testHandleSelectingCancel() {
        ...
        stateMachine.inputMethodEvent.collect(5).sink { events in
            ...
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.emphasized("▼戸")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼都")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽と")])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "o")))
    ...
    func testHandleSelectingSpaceBackspace() {
        ...
        stateMachine.inputMethodEvent.collect(11).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽あ")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.emphasized("▼1")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.emphasized("▼2")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼3")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼4")])), "変換候補パネルが表示開始")
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.emphasized("▼D")])), "9個先のDを表示")
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.emphasized("▼M")])), "9個先のMを表示")
            XCTAssertEqual(events[7], .markedText(MarkedText(text: [.emphasized("▼N")])))
            XCTAssertEqual(events[8], .markedText(MarkedText(text: [.emphasized("▼V")])), "Mの9個先のVを表示")
            XCTAssertEqual(events[9], .markedText(MarkedText(text: [.emphasized("▼W")])))
            XCTAssertEqual(events[10], .markedText(MarkedText(text: [.emphasized("▼M")])), "Vの9個前のMを表示")
            expectation.fulfill()
        }.store(in: &cancellables)
    ...
    func testHandleSelectingCtrlACtrlE() {
        ...
        stateMachine.inputMethodEvent.collect(8).sink { events in
            ...
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.emphasized("▼戸")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼都")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼徒")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.emphasized("▼途")])), "変換候補パネルが表示開始")
            XCTAssertEqual(
                events[6], .markedText(MarkedText(text: [.emphasized("▼斗")])), "Ctrl-eでは候補選択の現在のページの末尾候補が選択される")
            XCTAssertEqual(
                events[7], .markedText(MarkedText(text: [.emphasized("▼途")])), "Ctrl-aでは候補選択の現在のページの先頭候補が選択される")
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "t", withShift: true)))
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "o")))
    ...
    func testHandleSelectingNum() {
        ...
        stateMachine.inputMethodEvent.collect(8).sink { events in
            ...
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.emphasized("▼3")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.emphasized("▼4")])), "変換候補パネルが表示開始")
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.emphasized("▼5")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [.emphasized("▼6")])))
    ...
    func testHandleSelectingUnregister() {
        ...
        stateMachine.inputMethodEvent.collect(7).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽え")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.emphasized("▼絵")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("え /絵/ を削除します(yes/no)")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [.plain("え /絵/ を削除します(yes/no)"), .plain("y")])))
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("え /絵/ を削除します(yes/no)"), .plain("ye")])))
            XCTAssertEqual(events[5], .markedText(MarkedText(text: [.plain("え /絵/ を削除します(yes/no)"), .plain("yes")])))
            XCTAssertEqual(events[6], .markedText(MarkedText(text: [])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "e", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testPrivateMode() throws {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽t")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.plain("▽と")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.emphasized("▼都")])))
    ...
    func testCommitCompositionComposing() {
        ...
        stateMachine.inputMethodEvent.collect(6).sink { events in
            ...
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("n")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [])), "nが未確定になってても空文字列になる")
            XCTAssertEqual(events[4], .markedText(MarkedText(text: [.plain("▽い")])))
    ...
    func testCommitCompositionRegister() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽お")])))
            XCTAssertEqual(events[1], .modeChanged(.hiragana, .zero))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("[登録：お]")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "o", withShift: true)))
        XCTAssertTrue(stateMachine.handle(Action(keyEvent: .space, originalEvent: nil, cursorPosition: .zero)))
    ...
    func testCommitCompositionUnregister() {
        ...
        stateMachine.inputMethodEvent.collect(4).sink { events in
            XCTAssertEqual(events[0], .markedText(MarkedText(text: [.plain("▽お")])))
            XCTAssertEqual(events[1], .markedText(MarkedText(text: [.emphasized("▼尾")])))
            XCTAssertEqual(events[2], .markedText(MarkedText(text: [.plain("お /尾/ を削除します(yes/no)")])))
            XCTAssertEqual(events[3], .markedText(MarkedText(text: [])))
            expectation.fulfill()
        }.store(in: &cancellables)
        XCTAssertTrue(stateMachine.handle(printableKeyEventAction(character: "o", withShift: true)))
