...
- feat: 入力モードのモーダルの表示非表示のオプションを追加 (#276)
- fix: enable slash in composing mode (#281)
...
- 補完（`completion`）を辞書からも検索できるようにする (#180)
...
- `SKK-JISYO.L`の文字エンコーディングの変更を禁止にした (#174)
